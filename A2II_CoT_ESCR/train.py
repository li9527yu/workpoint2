...
def main(args):
    ...
    train_dataset=MyDataset(args,train_data,train_img_data,emotion_data,relation_data,caption_data,tokenizer)
    val_dataset=MyDataset(args,val_data,val_img_data,emotion_data,relation_data,caption_data,tokenizer)
    test_dataset=MyDataset(args,test_data,test_img_data,emotion_data,relation_data,caption_data,tokenizer)
    ...
    # wandb.log(
    #     {
    #         "test_acc": test_results['senti_acc'],
    #         "test_macro_f1": test_results['senti_f1'],
    #     })
