...
class MyDataset(Data.Dataset):
    def __init__(self,data_dir,tokenizer,Roberta_tokenizer,img_feat,qformer_rel,max_seq_len=64):
        self.tokenizer=tokenizer
        self.Roberta_tokenizer=Roberta_tokenizer
        self.max_seq_len=max_seq_len
        self.examples=self.creat_examples(data_dir)
        self.img_examples=img_feat
        self.qformer_rel=qformer_rel
    ...
    def __getitem__(self,index):
        ...
        rels=self.qformer_rel[index]
        return self.transform(line,rels)   
