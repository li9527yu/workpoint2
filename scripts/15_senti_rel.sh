...
do
    ...
    echo ${dataset}
    echo ${seed}
    python  A2II_senti-rel/train.py \
    --dataset ${dataset}\
    --data_dir /data/lzy1211/code/A2II/instructBLIP/img_data \
    --output_dir /data/lzy1211/code/A2II/instructBLIP/results/senti_rel-${dataset}/${seed} \
    --BATCH_SIZE 16\
    --seed ${seed} \
    --EPOCHS 20 \
    --LEARNING_RATE 5e-5  
...
#     --dataset ${dataset}\
#     --data_dir /data/lzy1211/code/A2II/instructBLIP/img_data \
#     --output_dir /data/lzy1211/code/A2II/instructBLIP/results/senti_rel-witoutLabel-${dataset}/${seed} \
#     --BATCH_SIZE 8\
#     --seed ${seed} \
#     --EPOCHS 20 \
#     --LEARNING_RATE 5e-5  
