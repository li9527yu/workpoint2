...
class MyDataset(Data.Dataset):
    ...
    def transform_three(self,line,img_line):
        ...
        image_emotion= value["img_clues_parsed"]
        # image_clue=f'The sentiment of {image_emotion["aspect"]} is {image_emotion["polarity"]}, because {image_emotion["evidence"]}'
        # image_clue=image_clue.lower()
        image_clue=image_emotion["evidence"]
        sentiment_map = {'0': 'neutral', '1': 'positive', '2': 'negative'}
        sentiment = sentiment_map[str(output_labels)]
        ...
        if semantic_relation_label==0 and emotional_relation_label==0:
            ...
            relation_s=1
            inputs=f"{instruction_related} Sentence: {text} Image Emotion: {image_clue} Aspect: {aspect} OPTIONS: -positive -neutral -negative OUTPUT:"
