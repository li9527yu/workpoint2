...
class MyDataset(Data.Dataset):
    def __init__(self,data_dir,img_feat_dir,tokenizer,max_seq_len=64):
    ...
    def get_img_feat(self,img_feat_dir):
        with open(img_feat_dir,"rb") as f:
            dict=pickle.load(f)  #[1,257,1408]
        # examples=[]
    ...
    def transform(self,line):
        ...
        img_=value["image"].split('/')[-1]
        img_feat=self.img_feats[img_]
