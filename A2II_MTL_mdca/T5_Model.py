...
class MyFlanT5(nn.Module):
    ...
    def forward(self,a_input_ids, a_attention_mask, a_decoder_output_labels,  iea_input_ids,
        ...
        return a_loss, iea_loss



    def generate(self,a_input_ids, a_attention_mask, a_decoder_output_labels,  iea_input_ids,
            iea_attention_mask, iea_decoder_output_labels,input_hidden_states):
        query=self.language_projection(input_hidden_states)
        ...
        return a_predicted_labels,iea_predicted_labels