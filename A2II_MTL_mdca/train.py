...
def evaluate(args,model,test_dataloader, logger):
    ...
    for batch in tqdm(test_dataloader, desc="Evaluating"):
            ...
            with torch.no_grad():
                a_sequence,   iea_sequence= model.generate(**inputs)
    ...
    results = {'a_results': a_results,  'iea_results': iea_results, 'semantic_rel_results': semantic_rel_results, 'emotion_rel_results': emotion_rel_results }
    results['avg_results'] = {}
    ...
    results['avg_results']['precision'] = (results['a_results']['precision'] +   results['iea_results']['precision']) / 2
    results['avg_results']['recall'] = (results['a_results']['recall'] +  results['iea_results']['recall']) / 2
