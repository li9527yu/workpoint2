...
class MyDataset(Data.Dataset):
    ...
    def trasform_original(self,line,img_line):
        ...
        if semantic_relation_label==1 or emotional_relation_label==1:
            ...
            inputs = f'{instruction_irrelevant}  Sentence: {text}  Image Description: {image_caption} Image Emotion: {image_emotion} aspect: {aspect}  OPTIONS: -positive -neutral -negative output:'
