...
do
    ...
    python  train.py \
    --dataset ${dataset}\
    --data_dir  /data/lzy1211/code/A2II/instructBLIP/CoT_data_process/gemini_img_clue \
    --img_feat_dir /data/lzy1211/code/A2II/instructBLIP/img_data \
    --output_dir /data/lzy1211/code/A2II/instructBLIP/results/A2II-ThreeRel-Gemini/Gemini_ImgClue/${dataset}/${seed} \
    --BATCH_SIZE 16\
    --seed ${seed} \
    --EPOCHS 20 \
    --LEARNING_RATE 5e-5
...
# AECR数据集对比qwen和Gemini的图像情感线索
# for seed in "24"
# do
#     echo ${seed}
#     python  train.py \
#     --dataset twitter2017 \
#     --data_dir  /data/lzy1211/code/A2II/instructBLIP/CoT_data_process/AECR_GeminiImg \
#     --img_feat_dir /data/lzy1211/code/A2II/instructBLIP/img_data \
#     --output_dir /data/lzy1211/code/A2II/instructBLIP/results/A2II-ThreeRel-Gemini/Gemini_ImgEmotion/AECR/${seed} \
#     --BATCH_SIZE 16\
#     --seed ${seed} \
#     --EPOCHS 20 \
#     --LEARNING_RATE 5e-5
...
#     --img_feat_dir /data/lzy1211/code/A2II/instructBLIP/img_data \
#     --output_dir /data/lzy1211/code/A2II/instructBLIP/results/A2II-ThreeRel-Gemini/Only_Img_Cules/${dataset}/${seed} \
#     --BATCH_SIZE 16\
#     --seed ${seed} \
#     --EPOCHS 20 \
#     --LEARNING_RATE 5e-5
...
#     --data_dir /data/lzy1211/code/A2II/instructBLIP/CoT_data_process/emotion_clue/ \
#     --img_feat_dir /data/lzy1211/code/A2II/instructBLIP/img_data \
#     --output_dir /data/lzy1211/code/A2II/instructBLIP/results/A2II-CoT-ThreeInfo/EmotionalRel_Image_Cules/woImg/${dataset}/${seed} \
#     --BATCH_SIZE 16\
#     --seed ${seed} \
#     --EPOCHS 20 \
#     --LEARNING_RATE 5e-5
