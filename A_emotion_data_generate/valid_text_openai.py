...
def parse_arguments():
    ...
    parser.add_argument("--data_dir", type=str, default="/data/lzy1211/code/A2II/instructBLIP/CoT_data_process/gemini_emotion_clues/gemini_data_text", help="Dataset directory")
    parser.add_argument("--output_dir", type=str, default="/data/lzy1211/code/A2II/instructBLIP/CoT_data_process/gemini_emotion_clues/gemini_data_text", help="Output directory")
    parser.add_argument("--img_dir", type=str, default="/data/lzy1211/code/twitterImage/", help="Images root directory")
    # 可选：模型/网关配置
