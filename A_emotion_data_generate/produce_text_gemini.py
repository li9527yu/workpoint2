...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", type=str, default="/data/lzy1211/code/A2II/instructBLIP/CoT_data_process/gemini_data_text", help="Dataset name")
...
if __name__ == "__main__":
    ...
    for type in types_split:
        ...
        for item in tqdm(datas, desc="data process"):
            ...
            if "textual_clues" not in item or item["textual_clues"] is None:
