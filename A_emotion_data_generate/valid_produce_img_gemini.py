...
def parse_arguments():
    ...
    parser.add_argument("--data_dir", type=str, default="/data/lzy1211/code/A2II/instructBLIP/CoT_data_process/gemini_emotion_clues/gemini_data", help="Dataset name")
    parser.add_argument("--output_dir", type=str, default="/data/lzy1211/code/A2II/instructBLIP/CoT_data_process/gemini_emotion_clues/gemini_data", help="Dataset name")
    parser.add_argument("--img_dir", type=str, default="/data/lzy1211/code/twitterImage/", help="Dataset name")
    return parser.parse_args()


if __name__ == "__main__":
    # 解析命令行参数  AIzaSyB5o1bZW_UjD6n9cLAjrxHTEcO6Ot_X-l8  AIzaSyDoqAnd490fwL2Cj0romzWL4oFDAy3d6fg  AIzaSyBioaXMDs9-kuNcS40mT3MGO7Ojp4xpndc  AIzaSyBQ9g7gcMSogvRS_85qLo8QmelF7peezbw
    ...
    for type in types_split:
        ...
        for item in tqdm(datas, desc="data process"):
            ...
            if "img_clue" not in item or item["img_clue"] is None or item["img_clue"] =="":
