...
def parse_arguments():
    ...
    parser.add_argument("--data_dir", type=str, default="/data/lzy1211/code/A2II/instructBLIP/CoT_data_process/gemini_emotion_clues/parese_img_clues", help="Dataset name")
    parser.add_argument("--output_dir", type=str, default="/data/lzy1211/code/A2II/instructBLIP/CoT_data_process/gemini_emotion_clues/parese_img_clues", help="Dataset name")
...
if __name__ == "__main__":
    ...
    for type in types_split:
        ...
        for item in tqdm(datas, desc=f"data process ({type})"):
            ...
            img_path = os.path.join(image_dir_path, item['image'])
            base64_image = encode_image(img_path)
            if "_raw" in item.get("img_clues_parsed", {}):
                response = describer.generate_itm(image_path_or_b64=base64_image, prompt=Question_reason, max_tokens=2048)
