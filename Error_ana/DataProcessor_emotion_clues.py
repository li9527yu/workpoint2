...
class MyDataset(Data.Dataset):
    ...
    def transform_three(self,line,img_line):
        ...
        return input_ids,input_multi_ids,input_attention_mask,input_multi_attention_mask,input_hidden_states,input_pooler_outputs,labels,output_labels,relation_s,line
