...
class MyDataset(Data.Dataset):
    ...
    def transform_three(self,line,img_line):
        ...
        if semantic_relation_label==0 and emotional_relation_label==0:
            ...
            im_inputs = f"{instruction_irrelevant} Sentence: {text} Sentence Emotion: {text_clue}  Aspect: {aspect} Description: {imagetext_meaning} OPTIONS: -positive -neutral -negative OUTPUT:"  
            ...
            im_inputs = f"{instruction_related} Sentence: {text} Sentence Emotion: {text_clue}  Aspect: {aspect} Description: {imagetext_meaning} OPTIONS: -positive -neutral -negative OUTPUT:" 
        else:
            relation_s=1
            ...
            im_inputs = f"{instruction_related} Sentence: {text} Sentence Emotion: {text_clue} Image Emotion: {image_emotion} Aspect: {aspect} Description: {imagetext_meaning} OPTIONS: -positive -neutral -negative OUTPUT:" 
