...
for seed in "24" "1000" "3000"
    do
        ...
        python  train.py \
            ...
            --output_dir /data/lzy1211/code/A2II/instructBLIP/results/A2II-ESCR_original/8-1e-4/${seed}/ \
            --BATCH_SIZE 8 \
            --seed ${seed} \
            --EPOCHS 15 \
            --LEARNING_RATE 1e-4
...
#         python  train.py \
#             --data_dir /data/lzy1211/code/annotation/data \
#             --output_dir /data/lzy1211/code/A2II/instructBLIP/results/A2II-ESCR_original/${bs}-${lr}/ \
#             --BATCH_SIZE ${bs} \
#             --seed 42 \
#             --EPOCHS 15 \
#             --LEARNING_RATE ${lr} 
...
# python  train.py \
#     --data_dir /data/lzy1211/code/annotation/data \
#     --output_dir /data/lzy1211/code/A2II/instructBLIP/results/A2II-ESCR_original/42/ \
#     --BATCH_SIZE 8\
#     --seed 42 \
#     --EPOCHS 10 \
#     --LEARNING_RATE 1e-4 \
